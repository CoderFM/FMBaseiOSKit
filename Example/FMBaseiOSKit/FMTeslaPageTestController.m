...
#import "FMTeslaPageTestController.h"
#import "FMCollectionCustomCell.h"
#import "FMCollectionCustomDecoration.h"

@interface FMTeslaTestFirstModel : FMTeslaPageModel

@end

@implementation FMTeslaTestFirstModel

- (void)didCreateScrollView:(UIScrollView *)scrollView{
    [super didCreateScrollView:scrollView];
    ...
    [(FMLayoutView *)scrollView setSections:page];
}
...
@interface FMTeslaPageTestController ()

@end

@implementation FMTeslaPageTestController
...
//            cell.contentView.backgroundColor =
    ...
    [self.pages addObject:[[FMTeslaTestFirstModel alloc] init]];
    [self.pages addObject:[[FMTeslaPageModel alloc] init]];
    [self.pages addObject:[[FMTeslaPageModel alloc] init]];
    [self.pages addObject:[[FMTeslaPageModel alloc] init]];
    [self.pages addObject:[[FMTeslaPageModel alloc] init]];
    [self.pages addObject:[[FMTeslaPageModel alloc] init]];
